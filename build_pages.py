...
SHARED_HEAD = '''  :root{
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  html{overflow-y:scroll}            /* reserve scrollbar space so centered layout never shifts between pages */
  body{
  ...
  .icon-btn{width:36px;height:34px;border-radius:18px;font-size:15px;line-height:1;display:inline-flex;align-items:center;justify-content:center;text-decoration:none}
  .icon-btn:hover{border-color:var(--hover)}
...
<meta charset="UTF-8">
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-0JZSCNHGZG"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-0JZSCNHGZG');
</script>
...
<body>
<div class="topbar">
  <a class="icon-btn" id="ghBtn" href="https://github.com/jcflyco/earnings-calendar" target="_blank" rel="noopener" title="GitHub" aria-label="GitHub"><svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg></a>
...
const T = {
  zh:{ htmlLang:'zh-CN', title:'财报日历 · 如何制作',
    ...
    aboutH2:'关于本项目',
    aboutP1:'本财报日历由 <span class="hl">长桥 (Longbridge) Skill</span> 制作。日历数据通过长桥 Skill 的财经日历接口自动获取。',
  ...
  en:{ htmlLang:'en', title:'Earnings Calendar · How it\\'s made',
    ...
    aboutP1:'This earnings calendar is built with the <span class="hl">Longbridge skill</span>. The calendar data is fetched automatically through the Longbridge skill\\'s finance-calendar API.',
    ...
    usage:'After installing, send the following to AI to generate the earnings calendar:',
